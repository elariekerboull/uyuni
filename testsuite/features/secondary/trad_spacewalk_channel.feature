...
Feature: Listing, adding and removing channels using the spacewalk-channel command
  ...
  Scenario: List available channels, verify child channels
    ...
    Then I should get "SLE15-SP4-Installer-Updates for x86_64"
  ...
  Scenario: Add a valid child channel
    When I use spacewalk-channel to add "SLE15-SP4-Installer-Updates for x86_64"
    And I use spacewalk-channel to list channels
    Then I should get "SLE15-SP4-Installer-Updates for x86_64"

  Scenario: Remove a valid child channel
    When I use spacewalk-channel to remove "SLE15-SP4-Installer-Updates for x86_64 "
    And I use spacewalk-channel to list channels
    Then I shouldn't get "SLE15-SP4-Installer-Updates for x86_64 "
