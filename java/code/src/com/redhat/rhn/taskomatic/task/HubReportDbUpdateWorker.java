...
public class HubReportDbUpdateWorker implements QueueWorker {
    ...
    public HubReportDbUpdateWorker(Logger loggerIn, MgrServerInfo sumaServerIn) {
        this.mgrServerInfo = sumaServerIn;
        this.log = loggerIn;
    }
    ...
    public void run() {
        try {
            ...
            ConnectionManager remoteDBCM = ConnectionManagerFactory.reportingConnectionManager(
                    ...
                    "jdbc:postgresql://" + mgrServerInfo.getReportDbHost() + ":" +
                            mgrServerInfo.getReportDbPort() + "/" + mgrServerInfo.getReportDbName()
                    );
